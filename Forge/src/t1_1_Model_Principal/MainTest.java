...
public class MainTest {
	...
	public static void main(String[] args) {
		System.out
				.println("\t\t-- Application de test en cmd de création,sauvegarde et chargement de parcours --\n\n");
		System.out.println("Création d'un nouveau parcours avec deux points\n");
		Point valence = new Point(180823, new Coordonnees(44.933014, 4.890892),
				0);
		Point saintay = new Point(205203, new Coordonnees(45.446958, 4.383396),
				0);
